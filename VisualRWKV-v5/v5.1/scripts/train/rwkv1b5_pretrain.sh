...
python train.py --load_model /data/huggingface_models/BlinkDL/rwkv-5-world/RWKV-5-World-1B5-v2-20231025-ctx4096.pth \
    --wandb "" --proj_dir out/rwkv1b5-${image_scanning}_pretrain \
