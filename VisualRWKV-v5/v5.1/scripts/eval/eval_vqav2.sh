...
#/data/Model_VisualRWKV/rwkv1b5-bidirection_mix665k/rwkv-10.pth 2048 -1 2048 24 /data/VisualRWKV-eval /data/pretrained-model/clip-vit-large-patch14-336 first bidirection
...
for IDX in $(seq 0 $((CHUNKS-1))); do
    CUDA_VISIBLE_DEVICES=${GPULIST[$IDX]} python ./evaluate.py \
        ...
        --question_file $eval_dir/eval/vqav2/$SPLIT.json \
        --output_file $eval_dir/eval/vqav2/answers/$SPLIT/$exp_name/${CHUNKS}_${IDX}.json \
        --num_chunks $CHUNKS \
        --chunk_idx $IDX \
