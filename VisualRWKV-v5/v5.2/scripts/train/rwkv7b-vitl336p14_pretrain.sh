...
python train.py --load_model /houhaowenT/huggingface_models/BlinkDL/rwkv-5-world/RWKV-5-World-7B-v2-20240128-ctx4096.pth \
    --wandb "" --proj_dir out/rwkv7b-vitl336p14_pretrain \
    ...
    --micro_bsz 8 --accumulate_grad_batches 8 --n_layer 32 --n_embd 4096 --pre_ffn 0 \
    --lr_init 1e-3 --lr_final 1e-5 --warmup_steps 540 --beta1 0.9 --beta2 0.99 --adam_eps 1e-8 \
    ...
    --freeze_rwkv 32 --freeze_proj 0 --detail low --grid_size -1 \
