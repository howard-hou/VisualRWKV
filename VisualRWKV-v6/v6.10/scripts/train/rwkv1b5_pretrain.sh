...
python train.py --load_model /houhaowenT/huggingface_models/BlinkDL/rwkv-6-world/RWKV-x060-World-1B6-v2.1-20240328-ctx4096.pth \
    ...
    --ctx_len 1024 --epoch_steps 1000 --epoch_count 4 --epoch_begin 0 --epoch_save 0 \
    ...
    --vision_tower_name /houhaowenT/huggingface_models/google/siglip-so400m-patch14-384 \
