...
python train.py --load_model /houhaowenT/huggingface_models/BlinkDL/rwkv-6-world/RWKV-x060-World-3B-v2.1-20240417-ctx4096.pth \
    --wandb "rwkv3b-v0612-448-mlp_pretrain" --proj_dir out/rwkv3b-v0612-448-mlp_pretrain \
    --data_file /houhaowenT/huggingface_datasets/LLaVA-Pretrain/blip_laion_cc_sbu_558k.json \
    --data_type "json" --vocab_size 65536 \
    --ctx_len 1320 --epoch_steps 1000 --epoch_count 17 --epoch_begin 0 --epoch_save 0 \
    --micro_bsz 32 --accumulate_grad_batches 4 --n_layer 32 --n_embd 2560 --pre_ffn 0 \
