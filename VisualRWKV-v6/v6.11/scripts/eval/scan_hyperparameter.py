...
def generate_cmd(args, task, value, script_dir):
    arg_list = [args.model_path, args.ctx_len, args.grid_size, args.n_embd, args.n_layer, args.eval_dir, args.image_position]
    arg_name_to_index = {"model_path": 0, "ctx_len": 1, "grid_size": 2, "n_embd": 3, "n_layer": 4, "eval_dir": 5, "image_position": 6}
