...
if __name__ == "__main__":
    ...
    parser.add_argument("--fill_image_features", default=1, type=int, help="fill the image features to the input_embeds")
...
"""
    ...
    from src.utils import (load_rwkv_from_pretrained, load_image_state_encoder_from_checkpoint, 
                           enable_state_encoder_pretrain_mode, load_visualrwkv_from_checkpoint)
